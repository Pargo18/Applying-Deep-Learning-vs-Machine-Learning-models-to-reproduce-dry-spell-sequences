...
def test_python_vs_matlab(family):
    ...
    if (family.lower() == 'gaussian'):
        ...
        if (gaussian_copula_test_result):
            ...
            print
            'Gaussian Copula Python calculation does NOT match Matlab!'
        ...
        # compare the two
        t_copula_test_result = np.allclose(t_copula_cdf_python, t_copula_cdf_matlab,
                                           atol=0.01)  # a high tolerance required
        # b/c of way that mvt
        ...
        if (t_copula_test_result):
            ...
            print
            'T Copula Python calculation does NOT match Matlab!'
        ...
        if (clayton_copula_test_result):
            ...
            print
            'Clayton Copula Python calculation does NOT match Matlab!'
        ...
        if (frank_copula_test_result):
            ...
            print
            'Frank Copula Python calculation does NOT match Matlab!'
        ...
        if (gumbel_copula_test_result):
            ...
            print
            'Gumbel Copula Python calculation does NOT match Matlab!'
